-- v10: The Flawless Script (Adding allowed_class_type_ids)
-- Error 23502: allowed_class_type_ids in packages is NOT NULL.
...
BEGIN
    ...
    -- 3. SELF-HEALING: Create Packages (Now with allowed_class_type_ids)
