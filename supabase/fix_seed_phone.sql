-- FIX: Add phone column to user_profiles and re-run seed
-- Error 42703 happened because 'phone' column was missing in user_profiles table.

-- 1. Add missing column
alter table user_profiles 
add column if not exists phone text;

-- 2. Re-run Massive Seed Logic (Copy-paste of previous seed logic correctly)
DO $$
DECLARE
    v_tenant_id uuid;
...
BEGIN
    ...
    FOR v_i IN 1..100 LOOP
        ...
        ) ON CONFLICT (user_id) DO NOTHING; -- in case of re-run
